...
10. **Done in v1.15.6:** preserve grouped chat-roll alternatives as native Foundry pools, including
  nested dice, modifiers, discarded results, and critical/fumble evidence.
11. **Done in v1.15.7:** preserve same-template placement alternatives when explicit names and
  complete template geometry distinguish the mutually exclusive casts.
...
20. **Done in v1.15.16:** preserve structurally identified donor-generated spell supplies without
  conflating them with source casting quotas (B107), and retain explicit identical-mechanics
  initial-save effect alternatives on one limited-innate quota while recurring saves stay free
